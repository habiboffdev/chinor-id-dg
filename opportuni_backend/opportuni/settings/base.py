"""
Django settings for opportuni project.
"""
import os
...
WSGI_APPLICATION = 'opportuni.wsgi.application'
ASGI_APPLICATION = 'opportuni.asgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Opportuni API',
    'DESCRIPTION': 'Student Opportunity Management Platform API',
    'VERSION': '1.0.0',
